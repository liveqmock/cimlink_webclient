...
public class QDParser {
  ...
  private final static int 
    ...
    PRE = 15,
    CDATA = 16;
  public static void parse(DocHandler doc,DataInputStream r) throws Exception {
      try{
    Stack st = new Stack();
    int depth = 0;
    int mode = PRE;
  ...
  private static boolean IsWhitespace(int c) {
      int[] wspace = {32,5760,6158,8192,8193,8194,8195,8196,8197,8198,8199,8200,8201,8202,8239,8287,12288,8232,8233,9,10,11,12,13,28,29,30,31};
      boolean ret = false;
